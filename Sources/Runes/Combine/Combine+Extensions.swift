...
/// Error extension allows simplified handling of completion error results
///
...
/// Collect extension allows SwftUI-like collection of multiple subscriptions into Set<AnyCancellable> w/o .store(in: &subscriptions) for each.
